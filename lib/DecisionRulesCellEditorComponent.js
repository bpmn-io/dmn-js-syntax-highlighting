  ...
  render() {
    ...
    return (
      <div className={ this.getClassName() }>
        ...
        {
          isFocussed ?
            <CellEditorComponent onChange={ onChange } value={ value } /> :
            <div contenteditable onFocus={ onFocus } className={ isScript ? 'script-editor' : null }>{ value }</div>
        }
        {
...
class CellEditorComponent extends Component {
  constructor(props, context) {
    super(props, context);
  ...
  componentWillUnmount() {
    this.editor.offChange(this.props.onChange);
